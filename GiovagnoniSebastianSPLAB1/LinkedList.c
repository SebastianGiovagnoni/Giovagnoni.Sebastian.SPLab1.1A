...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    {
        nNodo=(Node*)malloc(sizeof(Node));
        nNodo->pElement=pElement;

        if(nodeIndex == 0)
        {
            returnAux = 0;
            nNodo->pNextNode=this->pFirstNode;
            this->pFirstNode=nNodo;
            this->size++;
        }
        else
        {
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this!=NULL && index<ll_len(this) && index >= 0)
    {
        nNodo=getNode(this, index);
        if(nNodo!=NULL)
        {
            if(index == 0)
            {
                returnAux = 0;
                this->pFirstNode = nNodo->pNextNode;
                free(nNodo);
                this->size--;
            }
            else
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this!=NULL)
    {
        if(from>=0 && from<ll_len(this) && to>from && to<=ll_len(this))
        {
            ...
            {
                aux=getNode(this, i);
                addNode(cloneArray,ll_len(cloneArray),aux->pElement);
            }
        }
    }
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this!=NULL && pFunc!=NULL && (order==0 || order==1))
    {
        ...
        for(i=0; i<this->size-1; i++)
        {
            ...
            {
                criterio=pFunc(ll_get(this,i),ll_get(this,j));
                if(criterio==1 && order==1)
                {
                    aux=ll_get(this,i);
...
LinkedList* ll_filter(LinkedList* this,int (pFunc)(void*))
{
    ...
    if(this!=NULL)
    {
        ...
        for(i=0;i<ll_len(this);i++)
        {
            comp=pFunc(ll_get(this,i));
            if(comp==0)
            {
                //ll_add(this,ll_set(this,i,ll_get(this,i)));
